...
const zclAttrInfo_t onOff_attrTbl[] = {
    ...
    { ZCL_ATTRID_CUSTOM_KEY_LOCK,           ZCL_BOOLEAN,    RW,     (uint8_t*)&g_zcl_onOffAttrs.key_lock             },
    { ZCL_ATTRID_CUSTOM_LED,                ZCL_ENUM8,      RW,     (uint8_t*)&g_zcl_onOffAttrs.led_control          },
...
zcl_msAttr_t g_zcl_msAttrs = {
    ...
    .adjust_current = DEFAULT_ADJUST_MS,
    .voltage = 0xffff,
    .voltage_multiplier = 1,
    .voltage_divisor = 100,
    .voltage_min = DEFAULT_VOLTAGE_MIN,
    .voltage_max = DEFAULT_VOLTAGE_MAX,
    .adjust_voltage = DEFAULT_ADJUST_MS,
    .power = 0x8000,
    .power_multiplier = 1,
    .power_divisor = 100,
    .power_max = DEFAULT_POWER_MAX,
    .adjust_power = DEFAULT_ADJUST_MS,
...
const zclAttrInfo_t ms_attrTbl[] = {
    ...
    {ZCL_ATTRID_CUSTOM_ADJUST_CURRENT,      ZCL_INT8,     RW,   (uint8_t*)&g_zcl_msAttrs.adjust_current     },
    ...
    {ZCL_ATTRID_CUSTOM_ADJUST_VOLTAGE,      ZCL_INT8,     RW,   (uint8_t*)&g_zcl_msAttrs.adjust_voltage     },
    ...
    {ZCL_ATTRID_CUSTOM_ADJUST_POWER,        ZCL_INT8,     RW,   (uint8_t*)&g_zcl_msAttrs.adjust_power       },
